# 关于
OneManager-PHP是一个支持多平台部署，多网盘的列表程序，目前支持OneDrive、世纪互联、SharePoint、阿里云盘、~~GoogleDrive(目前无法挂载)~~、Sharelink。
Link：https://github.com/qkqpttgf/OneManager-php
...
How to Install:   
> ~~Click the button to Deploy a new app [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/qkqpttgf/OneManager-php)~~
...
4. 下载源码
   ...
   > `git@github.com:qkqpttgf/OneManager-php.git`
5. 设置.data/config.php文件权限为666
